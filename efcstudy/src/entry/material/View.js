...
define(function (require) {
    ...
    /**
     * @property {string} template 所使用的模板，entry-material-loading就是加载时的模板，require它来自动使用
     */
    overrides.template = 'entry-material';
